...
console.log('🕷️ [HoverStay Seeder] Seeding 9 DISTINCT Korean luxury hotel photos...');

const DISTINCT_REAL_HOTELS = [
  {
    id: 'signiel-seoul',
...
db.hotels = DISTINCT_REAL_HOTELS;
fs.writeFileSync(DB_FILE, JSON.stringify(db, null, 2), 'utf-8');

console.log('✅ Updated db.json with 9 completely distinct HD hotel photo URLs!');
