      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {MOCK_COUPONS.map((coupon) => (
          ...
          >
            ...
            <div className="relative z-10 pt-4 border-t border-gray-100 mt-4 flex items-center justify-between">
              <div className="bg-slate-50 px-3 py-1.5 rounded-lg border border-gray-200 text-xs font-mono font-bold text-gray-700">
                {coupon.code}
              </div>

              <button
                onClick={() => handleCopyCode(coupon.code)}
                className="flex items-center gap-1.5 text-xs font-bold text-primary hover:text-primary-container bg-blue-50 px-3.5 py-1.5 rounded-lg border border-blue-100 transition-colors"
              >
